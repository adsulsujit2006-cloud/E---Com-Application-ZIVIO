                ...
                <div className="col-span-1 text-sm space-y-3">
                    <div className="border rounded-md px-5 py-3 space-y-5">
                            ...
                            <div className="flex gap-3 text-sm items-center">
                                <div className="flex gap-3 text-sm items-center">
                                <LocalOffer sx={{color:teal[600],fontSize:"1px"}}/>
                          ...
                          {true ? <div className="flex justify-between items-center">
                            ...
                            :<div className="flex">
                                <div className="p-1 p1-5 pr-3 border rounded-md flex gap-2 items-center">
                                    <span className="">Sujit01 Applied</span>
                    ...
                    <div className="border rounded-md">
                        <PricingCard/>
                        <div onClick = {()=>navigate("/checkout")}className="p-5">
