...
public class PaymentServiceImpl implements PaymentService {
    ...
    private String stripSecrerkey = "stripesecretkey";
    ...
    public PaymentOrder getPaymentOrderById(Long paymentOrderId) throws Exception {
        return paymentOrderRepository.findById(paymentOrderId)
                .orElseThrow(() -> new Exception("Payment order not found with id: "));
    }
    ...
    @Override
    public Boolean ProceedPaymentOrder(PaymentOrder paymentOrder, String paymentId, String paymentLink)
